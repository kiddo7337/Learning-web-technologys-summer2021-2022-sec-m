		...
		<section style="width: 700px;margin: 50px 0px 0 400px;">
			...
			<fieldset style="width: 700px;">
				<table border="1">
					...
					if( $userArray[0] != null && $userArray[1] != null && $userArray[2] != null &&  $userArray[3] != null &&  $userArray[4] != null &&  $userArray[5] != null )
					{
					?>
					<tr>
						<td><?=$userArray[1]?></td>
						...
						<td><?=$userArray[4]?></td>
						<td><?=$userArray[5]?></td>
						<td><a href="panelupdate.php?id=<?php echo $userArray[0] ?>">Edit</a>|<a href="paneldelete.php?id=<?php echo $userArray[0] ?>">Delete</a></td>
					</tr>
					<?php
					}
						}
